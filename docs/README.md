...
| `contracts.md` — contratos de dados C0–C3 entre os produtos | ✅ (C0 validado, C1 `v1.0.0`, C2 `v1.2.0`, C3 `v1.0.0` — núcleo normativo; protocolo e superfície 🕓) | EM (guardião) |
| `decisions/` — ADRs (registros de decisão arquitetural) | ✅ (ADR-0001, ADR-0002 e ADR-0003 aceitos) | EM |
